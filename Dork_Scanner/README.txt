(+7 Days older than release date.)

A python3 file to check all of the dorks in the "Dorks.xlsx" Excel file.(so yea you'll need it in every versions of the file)
